	  ...
	  <div class="card-body">
	    ...
	    <form class="forms-sample" method="post" enctype="multipart/form-data" id="form" action="">
	      ...
	      <div class="form-group row">
	        ...
	        <div class="col-sm-9">
	          <input type="text" name="price" class="form-control" placeholder="Price" value="<?php echo number_format($product->price); ?>">
	      ...
	      <div class="form-group row">
	        ...
	        <div class="col-sm-9">
	          <input type="text" name="discount" class="form-control" placeholder="Discount" value="<?php echo number_format($product->discount); ?>">
	      ...
	      <div class="form-group row">
	        ...
	        <img src="<?php echo base_url('/upload/product/').$product->image_link; ?>" height="100px">
	        <div class="col-sm-9">
	      ...
	      <div class="form-group row">
			...
			<img src="<?php echo base_url('/upload/product/').$image; ?>" height="100px">
	    	<?php endforeach; ?>
	    	<?php endif; ?>
	        <div class="col-sm-9">
