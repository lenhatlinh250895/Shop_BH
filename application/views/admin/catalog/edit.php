...
<div class="col-md-12 grid-margin stretch-card">
	<div class="card">
	  <div class="card-body">
	    ...
	    <p class="card-description">Edit Catalog</p>
	    <form class="forms-sample" method="post" enctype="multipart/form-data" id="form" action="">
	        ...
	        <div class="col-sm-9">
	          <select name="parent_id">
	          	...
	          	<?php foreach($list as $row): ?>
	          		<option value="<?php echo $row->id; ?>" <?php echo ($info->parent_id == $row->id) ? "selected" : ""; ?> ><?php echo $row->name; ?></option>
	          	<?php endforeach ?>
	          </select>
	        </div>
	      </div>
	      <div class="form-group row">
	        ...
	        <div class="col-sm-9">
	          <input type="text" name="sort_order" class="form-control" placeholder="Sort Order" value="<?php echo $info->sort_order; ?>">
